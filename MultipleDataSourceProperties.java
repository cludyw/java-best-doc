...
public class MultipleDataSourceProperties {
    private Map<String, Object> byt;
    private Map<String, Object> travel;

    public DataSourceProperties getBytDataSourceProperties() {
        return convertDataSourceProperties(byt);
    }

    public DataSourceProperties getTravelDataSourceProperties() {
        return convertDataSourceProperties(travel);
    }
